...
import io.silverspoon.bulldog.devices.lcd.HD44780Compatible;
import io.silverspoon.bulldog.devices.lcd.HD44780Mode;
import io.silverspoon.bulldog.devices.lcd.Lcd;
import io.silverspoon.bulldog.devices.lcd.LcdFont;
import io.silverspoon.bulldog.devices.lcd.LcdMode;
...
public class LcdExample {
    final static Logger log = Logger.getLogger(LcdExample.class);
    ...
    private static Lcd init4Bit() throws IOException {
        ...
        // Create a pin IO group. This is a nice way of grouping output pins to
        // a parallel interface.
        // We can use the IO group like a datastream then and just write nibbles
        // to it.
        PinIOGroup ioGroup = new PinIOGroup(board.getPin(BBBNames.P8_12).as(DigitalIO.class), // enable
                // pin
        ...
        Lcd display = new HD44780Compatible(board.getPin(BBBNames.P8_11).as(DigitalOutput.class), // rs
                // pin
                board.getPin(BBBNames.P9_21).as(DigitalOutput.class), // rw pin
                ioGroup, HD44780Mode.FourBit);
        return display;
    }
    ...
    private static Lcd init8Bit() throws IOException {
        ...
        // Create a pin IO group. This is a nice way of grouping output pins to
        // a parallel interface.
        // We can use the IO group like a datastream then and just write bytes
        // to it.
        PinIOGroup ioGroup = new PinIOGroup(board.getPin(BBBNames.P8_12).as(DigitalIO.class), // enable
                // pin
    ...
    private static void doCoolStuffWithDisplay(Lcd display) {
        ...
        log.debug(display.read(1, 5, 4));
        log.debug(display.readLine(0));
        log.debug(display.readLine(1));

        display.home();
        log.debug(display.read(3));
